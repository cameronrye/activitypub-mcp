    ...
    this.mcpServer.registerResource(
      ...
      async (uri, { identifier }) => {
        try {
          ...
          throw new McpError(
            ErrorCode.InternalError,
            `Failed to fetch remote actor: ${error instanceof Error ? error.message : "Unknown error"}`,
          );
        }
      },
    );
    ...
    this.mcpServer.registerResource(
      ...
      async (uri, { identifier }) => {
        try {
          ...
          throw new McpError(
            ErrorCode.InternalError,
            `Failed to fetch remote timeline: ${error instanceof Error ? error.message : "Unknown error"}`,
          );
        }
      },
    );
    ...
    this.mcpServer.registerResource(
      ...
      async (uri, { domain }) => {
        try {
          ...
          throw new McpError(
            ErrorCode.InternalError,
            `Failed to fetch instance info: ${error instanceof Error ? error.message : "Unknown error"}`,
          );
        }
      },
    );
    ...
    this.mcpServer.registerResource(
      ...
      async (uri, { identifier }) => {
        try {
          ...
          throw new McpError(
            ErrorCode.InternalError,
            `Failed to fetch remote followers: ${error instanceof Error ? error.message : "Unknown error"}`,
          );
        }
      },
    );
    ...
    this.mcpServer.registerResource(
      ...
      async (uri, { identifier }) => {
        try {
          ...
          throw new McpError(
            ErrorCode.InternalError,
            `Failed to fetch remote following: ${error instanceof Error ? error.message : "Unknown error"}`,
          );
        }
      },
    );
