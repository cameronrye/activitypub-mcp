...
describe.skipIf(!process.env.RUN_INTEGRATION_TESTS)("Instance Blocklist Integration", () => {
  const client = new RemoteActivityPubClient();
...
describe.skipIf(!process.env.RUN_INTEGRATION_TESTS)("Cross-instance Federation Validation", () => {
  const client = new RemoteActivityPubClient();
